...
class Demandesrecues extends Component
{
    public $currentPage = PAGEDEMANDERECUES;
    ...
    public function render()
    {
        ...
        if($this->filtretype != ""){
            ...
            $this->affichage=1;
            return view('livewire.demandesrecues.index',[ 
    ...
    public function opendemande($id){
        $this->currentPage = PAGECONSULTERDEMANDERECUES;
    ...
    public function confirmValiderDemande($id,$id_user){
        
        $this->dispatchBrowserEvent("showConfirmMessage11",["message"=>[
    ...
    public function confirmRefuserDemande($id,$id_user){
        
        $this->dispatchBrowserEvent("showConfirmMessage12",["message"=>[
    ...
    public function valider($id_dem,$id_user){
        Demande::find($id_dem)->update([
            'archivee' => 1,
            'status' => 0,
        ]);
        $this->dispatchBrowserEvent("showSuccessMessage",["message"=>"Demande Validée"]);
        
    }
    public function refuser($id_dem,$id_user){
        Demande::find($id_dem)->update([
            'archivee' => 1,
            'status' => 1,
        ]);
        $this->dispatchBrowserEvent("showSuccessMessage",["message"=>"Demande Refusée"]);
