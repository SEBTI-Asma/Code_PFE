...
<body class="body_class">
    ...
    <div class="horizontal" id="id_horizontal" style="height:100%">
       ...
       <x-settings/> 
    <div>
    <p class="class_titreprincipale">Bienvenue <span>{{userFullName()}},</span></p>
    <p class="slogan"><span class="guillemet">"</span>GDD, L'application pour un monde qui change<span class="guillemet">"</span></p>
</div>
    </div>
    @livewireScripts
    <script>
