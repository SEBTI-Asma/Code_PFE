<div>
    <h2 class="titre_page"> Demandes Reçues</h2>
    <br>
    <div class="filter">
                ...
                @if ($mademandefiltre->annulee==0)
                    @if ($mademandefiltre->user_id!=auth()->user()->id)
                        <div class="une_demandes" style='cursor:pointer; '>
                            ...
                            <span style="padding-bottom:0; color:black;"wire:click.stop='opendemande({{$mademandefiltre->id}})' >
                ...
                @if ($mademandefiltre1->annulee==0)
                    @if ($mademandefiltre1->user_id!=auth()->user()->id)
                        <div class="une_demandes" style='cursor:pointer; '>
                            ...
                            <span style="padding-bottom:0; color:black;"wire:click.stop='opendemande({{$mademandefiltre1->id}})' >
